 ...
 * Used by the evidence auto-collector (Phase 5A) and PSP mappers (Phase 5C)
 * to convert structured hotel data into text when a PSP slot expects text
 * rather than a file.
 */
...
/**
 * Extract structured text from folio data.
 * Produces a formatted string with line items, dates, and amounts
 * suitable for PSP text evidence fields.
 */
...
/**
 * Extract structured text from reservation data.
 * Produces a formatted string with guest name, dates, room type, and
 * confirmation number suitable for PSP text evidence fields.
 */
...
/**
 * Extract structured text from activity logs.
 * Produces a chronological list of timestamps and events suitable
 * for PSP text evidence fields.
 */
